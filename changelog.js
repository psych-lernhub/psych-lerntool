...
(function () {
  /* CHANGELOG:START */
  var CHANGELOG = [
    { "d": "2026-09-23", "t": "inhalt", "s": "Entwicklungspsychologie B: neues Probeklausur-Mix-Set mit 42 Fragen — je drei der klausurnächsten Fragen aus jedem der 14 Best-of-Sets", "w": "Zum Üben am Stück quer durch alle Vorlesungen. Maßstab der Auswahl waren das Prüfungsprofil und die echte Altklausur als Stilreferenz; Fragen wortgleich mit den Best-of-Sets, der Fortschritt wird getrennt gespeichert." },
    { "d": "2026-09-22", "t": "inhalt", "s": "Entwicklungspsychologie B: 14 neue Best-of-Übungssets, je 30 ausgewählte KI-Fragen pro Vorlesung (aus 1.344 Fragen der Teilsets); die bisherigen Teilsets bleiben erhalten", "w": "Für die Klausurvorbereitung sollte je Vorlesung ein kompaktes Set mit den besten Fragen bereitstehen. Jede Frage wurde von drei unabhängigen Prüfern nach Klausurrelevanz, fachlicher Eindeutigkeit und Distraktorqualität bewertet; danach wurden Dubletten, Fragen mit Lösungsverrat zwischen Nachbarfragen und ratbare Fragen ausgetauscht. Fragen, Antworten und Lösungen sind wortgleich mit den Teilsets." },
    { "d": "2026-09-22", "t": "technik", "s": "Methodenlehre II: in allen 14 Vorlesungsmodulen ist die Reihenfolge der Antwortoptionen neu gemischt; 38 Erklärungen verweisen jetzt inhaltlich statt per Antwortbuchstabe auf die falschen Optionen", "w": "Wie in Entwicklungspsychologie B stand die richtige Antwort der Reihe nach immer auf a, b, c, d. Die Erklärungen dieses Moduls gingen die falschen Optionen bisher per Buchstabe durch (etwa „(d) vergisst die Division“); nach dem Mischen wäre das irreführend, deshalb nennen sie die Option jetzt beim Inhalt. Fragen, Antworttexte und Lösungen sind unverändert." },
    { "d": "2026-09-22", "t": "technik", "s": "Countdown: Methodenlehre II (Fr 25.09., 11:30) steht wieder im Prüfungsfenster; die vier defekten Wissensbasis-Dateien des Moduls sind repariert", "w": "Der Nachprüfungstermin ist bestätigt. Die Wissensbasis-Dateien enthielten seit Juni unmaskierte Anführungszeichen und waren nicht lesbar; die Reparatur fügt nur die fehlenden Maskierungen ein." },
    { "d": "2026-09-22", "t": "technik", "s": "Entwicklungspsychologie B: in allen 14 Vorlesungsmodulen ist die Reihenfolge der Antwortoptionen neu gemischt; das Qualitäts-Gate erkennt jetzt vorhersagbare Positionsfolgen", "w": "Die richtige Antwort stand in den Vorlesungsmodulen der Reihe nach immer auf a, b, c, d, a, b, c, d — wer das Muster bemerkt hatte, konnte ohne Lesen antworten. Fragen, Antworttexte und Lösungen sind unverändert; nur bei zehn Erklärungen wurde ein Verweis auf einen Antwortbuchstaben durch den Inhalt ersetzt. Die übrigen Module mit derselben Bauweise folgen nach den Klausuren." },
    { "d": "2026-09-05", "t": "inhalt", "s": "M4b Altklausur SoSe19 (Masterbank-Fassung): alle 54 💡-Erklärungen überarbeitet — der Verrat der Lösung ist von 91 % auf 44 % gefallen; Fragen, Antwortoptionen und Lösungen sind unverändert", "w": "Der Hinweis ist als Denkanstoß vor dem Antworten gedacht und nannte hier bisher fast immer die Lösung. Wo die richtige Antwort weiterhin ohne Stoffwissen erkennbar bleibt, liegt das an den Original-Antwortoptionen, die bei einer Altklausur unverändert bleiben." },
    { "d": "2026-09-05", "t": "inhalt", "s": "M5 KI-Übungsset 2: alle 50 💡-Erklärungen überarbeitet — der Verrat der Lösung ist von 100 % auf 74 % gefallen", "w": "Der Hinweis ist als Denkanstoß vor dem Antworten gedacht und nannte hier bisher ausnahmslos die Lösung. Dass die richtige Antwort oft weiterhin ohne Stoffwissen erkennbar bleibt, liegt in diesem Set an den Antwortoptionen selbst: Die falschen Optionen sind fast durchgehend absolut formuliert (nur, nie, ausschließlich). Das ist als Folgearbeit an den Optionen vermerkt." },
    { "d": "2026-09-04", "t": "inhalt", "s": "M4b Altklausur-Set: alle 52 💡-Erklärungen überarbeitet — der Verrat der Lösung ist von 94 % auf 44 % gefallen; Fragen, Antwortoptionen und Lösungen sind unverändert", "w": "Der Hinweis ist als Denkanstoß vor dem Antworten gedacht und nannte hier bisher fast immer die Lösung. Wo die richtige Antwort weiterhin ohne Stoffwissen erkennbar bleibt, liegt das an den Original-Antwortoptionen selbst (bei 17 der 52 Fragen tragen nur die falschen Optionen einen erläuternden Zusatz); die bleiben bei einer echten Altklausur unverändert." },
    { "d": "2026-09-04", "t": "inhalt", "s": "M4b KI-Übungsset: alle 81 💡-Erklärungen überarbeitet — der Verrat der Lösung ist von 100 % auf 44 % gefallen", "w": "In diesem Set nannte der Hinweis bisher ausnahmslos die Lösung; er ist als Denkanstoß vor dem Antworten gedacht. Wo die Antwort weiterhin ohne Stoffwissen erkennbar ist, liegt das an den Antwortoptionen (viele Distraktoren sind mit ausschließlich, nur oder allein formuliert) — das ist als Folgearbeit vermerkt. Vier Fragen sind zudem der falschen Vorlesung zugeordnet und wurden gemeldet." },
    { "d": "2026-09-04", "t": "inhalt", "s": "M5 Altklausur-Set (SoSe23): alle 50 💡-Erklärungen überarbeitet — sie verraten die Lösung nicht mehr; Fragen, Antwortoptionen und Lösungen sind unverändert", "w": "Der Hinweis ist als Denkanstoß vor dem Antworten gedacht und nannte hier bisher meist die Lösung. Bei einer echten Altklausur mit Begriffsfragen bleibt die richtige Antwort oft schon aus Frage und Antwortoptionen erkennbar — das ist Eigenschaft der Originalfragen und wurde nur dokumentiert." },
    { "d": "2026-09-04", "t": "inhalt", "s": "M5 Lernfragen-Set: alle 37 💡-Erklärungen überarbeitet — sie geben die Lösung nicht mehr vorweg", "w": "Der Hinweis ist als Denkanstoß vor dem Antworten gedacht; in diesem Set nannte er bisher fast immer die Lösung. Wo die richtige Antwort trotzdem ohne Stoffwissen erkennbar bleibt, liegt das an den Antwortoptionen selbst — das ist als Folgearbeit vermerkt." },
    { "d": "2026-09-04", "t": "technik", "s": "Qualitäts-Gate prüft jetzt auch die Wissensbasis-Dateien (JSON) aller Module auf Lesbarkeit", "w": "In einem Modul lagen vier Wissensbasis-Dateien seit Juni mit einem Syntaxfehler unbemerkt vor, weil kein Gate sie je gelesen hat; das Sanierungs-Werkzeug bricht bei solchen Dateien jetzt mit klarer Meldung ab statt mit einem Traceback." },
    { "d": "2026-09-04", "t": "technik", "s": "Countdown: im September-Fenster stehen nur noch Sozialpsychologie (21.09.) und Entwicklungspsychologie B (23.09.); Methodenlehre II ist aus dem Countdown genommen", "w": "Die Nachprüfung Methodenlehre II wird verschoben; der Countdown soll nur Termine zeigen, die wirklich anstehen." },
    { "d": "2026-09-04", "t": "technik", "s": "Kampagnen-Dashboard auf Stand gebracht: M4b-Übungsset-Kette als abgeschlossen geführt, Hinweis-Überarbeitung als eigene Kampagne sichtbar", "w": "Das Dashboard zeigte für M4b noch den Juli-Stand, obwohl seit dem 22.08. alle 14 Vorlesungen ein eigenes Übungsset haben; die laufende Überarbeitung der 💡-Hinweise fehlte ganz." },
    { "d": "2026-08-25", "t": "inhalt", "s": "M5 KI-Übungsset: alle 50 💡-Erklärungen neu geschrieben — sie geben die Lösung nicht mehr vorweg", "w": "Der Hinweis ist als Denkanstoß VOR dem Antworten gedacht und war mit „Erklärung — ohne Lösung\" beschriftet. Tatsächlich nannte er meist die richtige Antwort und schloss die falschen aus, womit die Frage ihren Übungswert verlor. Die neuen Hinweise benennen nur noch, woran zu prüfen ist. Fragen, Antworten und die Volllösung sind unverändert." },
    { "d": "2026-08-24", "t": "inhalt", "s": "M4b abgeschlossen: Antwortoptionen im großen KI-Übungsset (81 Fragen) überarbeitet — damit sind alle Übungsmaterialien des Moduls durch", "w": "Die richtige Antwort war fast immer die zweitlängste Option und trug als einzige eine Klammer-Präzisierung. Dabei fiel zusätzlich auf, dass einzelne Distraktoren die Lösung einer anderen Frage desselben Sets verrieten; auch das ist behoben. Inhalt und Lösungen bleiben unverändert." },
    { "d": "2026-08-24", "t": "inhalt", "s": "M4b: Antwortoptionen in den letzten beiden Vorlesungs-Lernmodulen (VL13, VL14) überarbeitet — damit sind alle 14 Vorlesungen durch", "w": "Die richtige Antwort war dort fast immer die zweitlängste Option und trug als einzige eine Klammer-Präzisierung. Beides ließ sich ohne Fachwissen ausnutzen; Inhalt und Lösungen bleiben unverändert." },
    { "d": "2026-08-23", "t": "inhalt", "s": "M4b: Antwortoptionen in drei weiteren Vorlesungs-Lernmodulen (VL10 bis VL12) überarbeitet", "w": "Die richtige Antwort war dort fast immer die zweitlängste Option — das ließ sich ohne Fachwissen ausnutzen. Die Optionen sind jetzt gleichmäßig lang; Inhalt und Lösungen bleiben unverändert." },
{
  "d": "2026-08-23", "t": "inhalt",
  "s": "Entwicklungspsychologie B, Vorlesungen 7 bis 9: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In den Lernmodulen dieses Moduls ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst; damit sind neun der vierzehn Vorlesungen überarbeitet."
},
{
  "d": "2026-08-23", "t": "inhalt",
  "s": "Entwicklungspsychologie B, Vorlesungen 4 bis 6: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In den Lernmodulen dieses Moduls ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst und in mehreren unabhängigen Prüfrunden bestätigt; die weiteren Vorlesungen folgen."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Entwicklungspsychologie B, Vorlesungen 1 bis 3: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In den Lernmodulen dieses Moduls ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst und in mehreren unabhängigen Prüfrunden bestätigt; die weiteren Vorlesungen folgen."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Entwicklungspsychologie B: neues KI-Übungsset zur Vorlesung 14 (Tod & Sterben) — 74 Fragen in zwei Teilen. Damit hat jede der 14 Vorlesungen ein eigenes Übungsset.",
  "w": "Von diesem Deck war knapp die Hälfte seit Juli unfertig liegen geblieben. Die fehlenden Fragen sind jetzt gebaut, jede Falschantwort ist an eine Belegstelle der Vorlesung gebunden."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Entwicklungspsychologie B: neues KI-Übungsset zur Vorlesung 12 (Lebenszufriedenheit) — 89 Fragen in drei Teilen.",
  "w": "Auch zu dieser Vorlesung fehlten für die Wiederholungsklausur am 23.09. noch Übungsfragen. Vor der Freigabe wurde jedes der zwölf Fragenpakete einzeln nachgerechnet; zwei mussten nachgebessert werden."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Entwicklungspsychologie B: neues KI-Übungsset zur Vorlesung 13 (Selbst & Persönlichkeit) — 91 Fragen in drei Teilen.",
  "w": "Für die Wiederholungsklausur am 23.09. fehlten zu dieser Vorlesung noch Übungsfragen. Jede Falschantwort ist an eine Belegstelle der Vorlesung gebunden, jede Frage hat Lösung und Hinweis."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Prüfungs-Countdown auf den Nachprüfungszeitraum aktualisiert: Sozialpsychologie 21.09. (12:30) · Entwicklungspsychologie B 23.09. (09:00) · Wissenschaftliche Methodenlehre II 25.09. (11:30) — alle im Alten Gymnasium, Raum Sparkasse OPR. Abgelaufene Termine wurden entfernt.",
  "w": "Der offizielle Prüfungsplan (Stand 14.08.) ist da — der Countdown zeigt jetzt die echten Termine."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Allgemeine Verfahrenslehre I, Vorlesungen 8 bis 10: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In diesem Modul ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst; in den Prüfrunden wurden zusätzlich mehrere übertrieben formulierte Falschoptionen durch fachlich ernsthafte Alternativen ersetzt."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Allgemeine Verfahrenslehre I, Vorlesungen 5 bis 7: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In diesem Modul ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst; in den Prüfrunden wurden zusätzlich einige zu knapp geratene Antworten und übertrieben formulierte Falschoptionen nachgebessert."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Allgemeine Verfahrenslehre I, Vorlesungen 2 bis 4: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In diesem Modul ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Für diese drei Vorlesungen ist das jetzt aufgelöst und in mehreren unabhängigen Prüfrunden bestätigt; die weiteren Vorlesungen folgen."
},
{
  "d": "2026-08-22", "t": "inhalt",
  "s": "Allgemeine Psychologie A, Urteilen & Entscheiden: Antwortoptionen in zwei Fragen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der richtigen Antwort.",
  "w": "Bei der letzten Überarbeitung dieses Moduls war die richtige Antwort in diesen beiden Fragen sprachlich anders gebaut als die übrigen Optionen und dadurch erkennbar, ohne den Stoff zu können. Das ist jetzt aufgelöst und in mehreren unabhängigen Prüfrunden bestätigt."
},
{
  "d": "2026-08-21", "t": "inhalt",
  "s": "Allgemeine Verfahrenslehre I, Vorlesung 1: Antwortoptionen überarbeitet. Fragen, Lösungen und Erklärungen sind unverändert — nur die Formulierung der Antwortmöglichkeiten.",
  "w": "In diesem Modul ließ sich die richtige Antwort bisher oft schon an ihrer Form erkennen, ohne den Stoff zu können. Das ist für diese Vorlesung jetzt aufgelöst und in mehreren unabhängigen Prüfrunden bestätigt; die weiteren Vorlesungen folgen."
},
{
  "d": "2026-08-21", "t": "inhalt",
  "s": "Allgemeine Psychologie A, Wahrnehmung II: Antwortoptionen in fünf Fragen überarbeitet. Fragen, Lösungen, Erklärungen und Hinweise sind unverändert — nur die Formulierung einzelner Antwortmöglichkeiten.",
  "w": "Bei der letzten Überarbeitung dieses Moduls war in diesen Fragen ein Formatmerkmal versehentlich einseitig verteilt worden, sodass sich die richtige Antwort daran erkennen ließ, ohne den Stoff zu können. Das ist jetzt aufgelöst und durch zwei unabhängige Prüfrunden bestätigt."
},
{
  "d": "2026-08-21", "t": "technik",
  "s": "Datumskorrektur: Zwei Einträge dieser Liste trugen ein falsches Datum (die M2a-Überarbeitung fand am 14.08. statt, die Anzeige-Fehler-Behebung am 21.08.). Nur die Datumsangaben wurden berichtigt, die Inhalte sind unverändert.",
  "w": "Damit die Zeitleiste hier stimmt."
},
{
  "d": "2026-08-21", "t": "technik",
  "s": "Anzeige-Fehler behoben: In 52 Fragen verwies die Auflösung auf eine Position („richtig ist d“, „die dritte Option“) — die Antwortoptionen wurden aber trotzdem gemischt, sodass der Verweis ins Leere zeigte. Solche Fragen behalten ihre Reihenfolge jetzt zuverlässig bei; die Erkennung berücksichtigt zusätzlich das Hinweisfeld.",
  "w": "Die Schutzregel kannte nur einen Teil der möglichen Formulierungen und sah das Hinweisfeld gar nicht an — beides ist jetzt abgedeckt und durch Regressionstests gesichert."
},
{
  "d": "2026-08-14", "t": "inhalt",
  "s": "M2a: Antwortoptionen aller Lernmodule und des Übungssets überarbeitet. Die Optionen einer Frage sind jetzt gleichmäßig gebaut — keine fällt mehr durch Länge oder Satzform aus dem Rahmen, und Klammern, Semikola, Doppelpunkte, Schrägstriche und Anführungszeichen wurden in normalen Satzbau aufgelöst. Fragetexte, Lösungen, Erklärungen und Hinweise blieben unverändert; jede Änderung wurde blind fachlich nachgeprüft und gegen die Vorlesungsunterlagen belegt. Die automatische Prüfung ist für M2a ab jetzt verbindlich. Die echte Altklausur bleibt unangetastet.",
  "w": "Damit sich die Fragen nur noch über den Inhalt lösen lassen und nicht über die äußere Form der Antworten — wichtig für den Wiederholungsversuch im September."
},
{
  "d": "2026-07-31", "t": "inhalt",
  "s": "M5: Antwortoptionen aller Übungssets überarbeitet — damit ist M5 komplett. Über alle Lernmodule, Vertiefungen und Übungssets hinweg sind die Optionen einer Frage jetzt gleichmäßig gebaut: keine Option fällt mehr durch Länge oder Satzform aus dem Rahmen, Formulierungen wurden näher an den Folienwortlaut gerückt. Fragetexte, Lösungen, Erklärungen und Hinweise blieben unverändert; jede Änderung wurde blind fachlich nachgeprüft und gegen die Vorlesungsunterlagen belegt. Die automatische Prüfung ist für M5 ab jetzt verbindlich, damit das nicht zurückfällt.",
  "w": "Damit sich Fragen nur noch über den Inhalt lösen lassen und nicht über die äußere Form der Antworten."
},
{
  "d": "2026-07-31", "t": "inhalt",
  "s": "M5: Antwortoptionen der fünf Vertiefungsmodule überarbeitet und die Vorlesungsmodule sprachlich nachgezogen. Appositionen mit Gedankenstrich wurden in normale Sätze aufgelöst, Optionslängen innerhalb einer Frage angeglichen und einzelne Formulierungen näher an den Folienwortlaut gerückt. Fragetexte, Lösungen, Erklärungen und Hinweise blieben unverändert; jede Änderung wurde blind fachlich nachgeprüft und gegen die Vorlesungsunterlagen belegt.",
  "w": "Fortsetzung der Überarbeitung vom selben Tag: Optionen sollen sich nur über den Inhalt unterscheiden, nicht über ihre äußere Form."
},
{
  "d": "2026-07-31", "t": "inhalt",
  "s": "M5: Antwortoptionen der zwölf Vorlesungsmodule überarbeitet. Die Optionen einer Frage sind jetzt gleichmäßiger formuliert, Formulierungen wurden an den Folienwortlaut angeglichen und uneinheitliche Satzformen vereinheitlicht. Fragetexte, Lösungen, Erklärungen und Hinweise blieben unverändert; jede Änderung wurde blind fachlich nachgeprüft und gegen die Vorlesungsunterlagen belegt.",
  "w": "Eine frühere Überarbeitungsrunde hatte die Optionen unbeabsichtigt so vereinheitlicht, dass sich Fragen teilweise an der Form statt am Inhalt lösen ließen — das ist jetzt behoben."
},
{
  "d": "2026-07-31", "t": "technik",
  "s": "Gate- und Werkzeug-Härtung (Analyse-Backlog Block 2): qa prüft jetzt zusätzlich globale Speicher-Schlüssel-Eindeutigkeit, die Aktualität des verschlüsselten Hubs (eingebetteter Quell-SHA), einen Klartext-Scan aller versionierten Seiten, die Hook-Aktivierung und die P8-Detektor-Tests; node ist harte Voraussetzung; fehlende/leere Quelldaten und ausgehebelte Sync-Blöcke sind harte Fehler. Fortschritts-Sicherung erfasst jetzt auch den Lernstand der M11a-Anwendungstrainer (Export UND Import); Fortschritts-Panel klassifiziert die Voll-Probeklausur korrekt; Lernmodul-Zähler im Hub bereinigt. Engine-Tests 21→30 Checks (u. a. Malus-Scoring) + 7 Drift-Guards; geteilte SRS-/Regel-Bausteine in gemeinsame Quellen zusammengeführt; Extraktions-Gates melden einen nicht durchführbaren TÜV jetzt ehrlich; Seed-Test-Konstruktionsfehler behoben (Recall 5/5).",
  "w": "Die Projekt-Analyse fand mehrere Still-grün-Pfade, in denen Prüfungen unbemerkt ausfallen konnten — sie sind jetzt geschlossen; die Gates sagen nur noch dann grün, wenn wirklich geprüft wurde."
},
{
  "d": "2026-07-31", "t": "technik",
  "s": "Projekt-Tiefenanalyse + Doku-Refresh: Kampagnen-Dashboard auf den echten Stand gebracht, ein verwaistes M5-Übungsset (nirgends verlinkt, veralteter Stand vom 14.07.) entfernt, Regelwerk-Doku ergänzt (R15-Ausnahme für unveränderte Original-Prüfungsfragen), README aktualisiert.",
  "w": "Eine systematische Analyse des Gesamtprojekts ergab, dass mehrere Status-Anzeigen und Doku-Stände seit Mitte Juli eingefroren waren — sie sind jetzt wieder verlässlich."
},
{
